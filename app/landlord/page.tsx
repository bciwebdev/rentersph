  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (totalAmount > 0) {
        ...
        alert("Listing submitted successfully! It is now pending administrative approval.")
        setCurrentView('dashboard')
        resetForm()
      }
        ...
        {verificationStatus === 'unverified' && (
          <div className="mb-6 bg-amber-50/80 border border-amber-200/80 p-5 rounded-3xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shadow-sm">
            <div className="flex items-start gap-3.5">
              ...
              <div>
                <h4 className="text-sm font-black text-amber-900">Identity Verification Recommended</h4>
                <p className="text-xs text-amber-700/90 mt-0.5">
                  Verify your identity to receive a verified badge and increase trust across rentersPH.
                </p>
              </div>
            </div>
            <button
            ...
            <div className="flex items-start gap-3.5">
              ...
              <div>
                ...
                <p className="text-xs text-blue-700/90 mt-0.5">
                  Your identity verification details have been submitted and are currently being reviewed by an administrator.
                </p>
              </div>
            </div>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl max-w-lg w-full p-6 shadow-2xl relative my-8">
            ...
            <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Get a verified badge for your profile.</p>
              </div>
            </div>
